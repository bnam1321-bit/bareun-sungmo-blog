                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                    ...
                    <div className="col-span-1 lg:col-span-2">
                        <Link href="/" className="inline-block mb-6">
                            <span className="text-2xl font-black text-stone-900 drop-shadow-sm">더바른성모내과</span>
                        </Link>
                        ...
                        <ul className="space-y-3 text-sm">
                            <li className="flex justify-between items-start border-b border-stone-100 pb-2">
                                ...
                                <div className="text-right text-stone-600">
                                    <span className="block font-medium text-stone-900">08:00 - 18:00</span>
                            ...
                            <li className="flex justify-between items-start border-b border-stone-100 pb-2">
                                ...
                                <div className="text-right text-stone-600">
                                    <span className="block font-medium text-stone-900">08:00 - 14:00</span>
