        ...
        <div className="min-h-screen bg-stone-50 py-20 px-4">
            <div className="max-w-6xl mx-auto">
                <div className="text-center mb-16">
                    ...
                    <p className="text-xl text-stone-600 font-medium">더바른성모내과는 다음과 같은 서비스를 제공합니다</p>
                </div>
                ...
                <div className="bg-white rounded-3xl p-12 shadow-xl border border-stone-100">
                    ...
                    <div className="max-w-2xl mx-auto space-y-4">
                        <div className="flex justify-between py-3 border-b border-stone-100">
                            ...
                            <span className="text-stone-600">08:00 ~ 18:00</span>
                        </div>
                        <div className="flex justify-between py-3 border-b border-stone-100">
                        ...
                        <div className="flex justify-between py-3 border-b border-stone-100">
                            ...
                            <span className="text-stone-600">08:00 ~ 14:00</span>
                        </div>
